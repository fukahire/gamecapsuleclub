...
<template>
    ...
    <div>
        ...
        <div class="flex flex-col gap-2 justify-center items-center mt-12">
            ...
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSd_dGGXBrQEbgNzzapC0qJtgX5AV227oGPThU10XL8YJRZO3A/viewform" class="bg-[#30507a] hover:bg-[#e5ad55] border-3 rounded-full py-2 font-bold text-white border-white w-80 block" target="_blank">場內only登記表單</a>
